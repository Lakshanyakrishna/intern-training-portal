  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-2">
        {STATUS_STEPS.map((step, i) => (
          <div key={step} className="flex items-center gap-2 flex-1">
            <div className={`flex-1 h-1.5 rounded-full ${i <= currentStepIndex ? 'bg-accent' : 'bg-surface-alt'}`} />
      ...
      <div className="bg-surface border border-line rounded-xl p-5 space-y-3">
        <h2 className="text-sm font-semibold text-primary">Your Submission</h2>
        ...
        {submission.requiresFile && (
          <button className="w-full flex items-center justify-center gap-2 px-4 py-6 rounded-lg border-2 border-dashed border-line text-sm text-secondary hover:border-accent hover:text-accent transition-colors">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg bg-accent text-accent-text text-sm font-medium hover:opacity-90 transition-opacity disabled:opacity-60"
        >
      ...
      {/* Mentor feedback */}
      <div className="bg-surface border border-line rounded-xl p-5">
        <h2 className="text-sm font-semibold text-primary mb-2">Mentor Feedback</h2>
