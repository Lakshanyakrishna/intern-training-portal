  ...
  const highlights = [
    {
      ...
      desc: 'Get direct constructive feedback on your pull requests. Senior engineers analyze your performance, styling, structure, and design patterns.',
      color: '#FFFFFF'
    },
    {
      icon: Users,
      title: 'Dedicated Office Hours',
      desc: 'Schedule individual face-to-face sessions to resolve complicated technical blocks, debug complex problems, or structure your path.',
      color: '#E5E5E5'
    },
    {
      icon: GraduationCap,
      title: 'System Design Guidance',
      desc: 'Understand how real-world applications are architected. Learn database design, api scaling, authentication, and security strategies.',
      color: '#A3A3A3'
    },
    {
      icon: Award,
      title: 'Industry Endorsements',
      desc: 'Upon completing your internship, receive direct written feedback and linkedin endorsements from team leads to validate your readiness.',
      color: '#737373'
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-[#F1F2EE] font-sans selection:bg-white/10 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-[20%] -right-[30%] w-[90%] h-[90%] rounded-full bg-[radial-gradient(circle_at_center,rgba(154,161,163,0.02)_0%,transparent_60%)]" />
        {/* Subtle grid pattern */}
      ...
      <main className="relative z-10 max-w-6xl mx-auto px-6 pt-32 pb-24 md:pt-40">
        ...
        <div className="max-w-3xl mb-20">
          ...
          >
            Build your coding habits alongside experienced engineering leads who give actionable feedback and code quality advice.
          </motion.p>
        </div>
          ...
          <div className="max-w-2xl">
            ...
            <div className="space-y-8">
              <div className="flex gap-4">
                <div className="w-8 h-8 rounded-full bg-[#8B5CF6]/10 text-[#8B5CF6] flex items-center justify-center text-sm font-semibold shrink-0">✓</div>
                <div>
                  <h4 className="font-semibold text-white text-sm mb-1">Active Tech Leads</h4>
                  <p className="text-xs text-[#A8A8A8] leading-relaxed font-light">Your mentors are not full-time teachers; they are active senior developers and technology leads working at high-growth tech companies.</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-white text-sm mb-1">Constructive Code Audits</h4>
                  <p className="text-xs text-[#A8A8A8] leading-relaxed font-light">Every pull request is reviewed line-by-line. Learn optimization tips, structural suggestions, styling details, and best practices directly in code reviews.</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-white text-sm mb-1">Engineering Habits</h4>
                  <p className="text-xs text-[#A8A8A8] leading-relaxed font-light">Learn Git workflow hygiene, clean writing standards, automated linting controls, and systems checking that set top-percentile junior engineers apart.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        >
          ...
          <p className="text-sm text-[#A8A8A8] max-w-md mx-auto mb-8 relative z-10 leading-relaxed font-light">
            Receive detailed personal feedback and leveling support. Apply for the Frontend Developer Intern role now.
          </p>
