        ...
        <header className="border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
          <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <Link to="/opportunities" className="text-xs text-blue-600 dark:text-blue-400 font-medium">Opportunities</Link>
            </div>
          </div>
        </header>
        <main className="max-w-2xl mx-auto px-4 py-16 text-center">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Opportunity Not Found</h1>
          <p className="text-gray-500 dark:text-gray-400 mb-6">This opportunity may have been removed or doesn't exist.</p>
          <Link to="/opportunities" className="px-6 py-2.5 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors text-sm">
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        <Link to="/opportunities" className="inline-flex items-center gap-1 text-sm text-blue-600 dark:text-blue-400 hover:underline mb-6">
          &larr; Back to Opportunities
        </Link>

        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-8 md:p-10">
          <div className="flex items-center gap-3 mb-4">
            <span className={`text-xs font-medium px-3 py-1 rounded-full capitalize ${categoryColors[opportunity.category] || 'bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400'}`}>
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">{opportunity.title}</h1>

          <div className="prose prose-sm dark:prose-invert max-w-none text-gray-600 dark:text-gray-400 leading-relaxed whitespace-pre-wrap mb-8">
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
            <Link
              ...
              className="inline-flex items-center justify-center px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors text-sm"
            >
              Apply Now
            </Link>
          </div>
